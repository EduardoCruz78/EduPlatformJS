    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Primeiro escolha a série, depois vincule as matérias corretas.
          </p>
        </div>
      </div>
      ...
      <Card className="max-w-3xl">
        <CardHeader>
          ...
          <CardDescription>
            A filtragem por série evita misturar matérias de anos diferentes.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Se um mesmo tema existir em outra série, cadastre outro vínculo conscientemente.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
