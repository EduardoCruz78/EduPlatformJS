...
exports.Prisma.TopicSubjectScalarFieldEnum = {
  topicId: 'topicId',
  subjectId: 'subjectId'
};

exports.Prisma.VestibularScalarFieldEnum = {
  id: 'id',
  name: 'name',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt'
...
exports.Prisma.VestibularSubjectScalarFieldEnum = {
  vestibularId: 'vestibularId',
  subjectId: 'subjectId'
};

exports.Prisma.VestibularContentScalarFieldEnum = {
  id: 'id',
  vestibularId: 'vestibularId',
  title: 'title',
  type: 'type',
...
exports.Prisma.VestibularTopicScalarFieldEnum = {
  id: 'id',
  vestibularId: 'vestibularId',
  name: 'name',
...
exports.Prisma.AccessibilityCategoryScalarFieldEnum = {
  id: 'id',
  name: 'name',
...
exports.Prisma.AccessibilityCategoryTopicScalarFieldEnum = {
  accessibilityCategoryId: 'accessibilityCategoryId',
  topicId: 'topicId'
};

exports.Prisma.AccessibilityNeedScalarFieldEnum = {
  id: 'id',
  accessibilityCategoryId: 'accessibilityCategoryId',
  name: 'name',
  createdAt: 'createdAt',
...
exports.Prisma.AccessibilityThemeScalarFieldEnum = {
  id: 'id',
  accessibilityCategoryId: 'accessibilityCategoryId',
